...
def when_apply_migrations_given_no_migrations_path__then_uses_default_path_pattern() -> None:
    ...
    with patch('deev.common.DbMigrator.DbMigrator.apply') as mock_apply, \
            patch('deev.common.DbMigrator.DbMigrator.__init__') as init_p:  # type: ignore[arg-type]
        init_p.returns(None)
...
def when_undo_migrations_given_no_migrations_path__then_uses_default_path_pattern() -> None:
    ...
    with patch('deev.common.DbMigrator.DbMigrator.undo') as mock_undo, \
            patch('deev.common.DbMigrator.DbMigrator.__init__') as init_p:  # type: ignore[arg-type]
        init_p.returns(None)
