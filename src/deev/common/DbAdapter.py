        ...
        if self.__connection is not None:
            match type(self.__connection).__name__:
                case 'MysqlProxyConnection' | 'MySQLConnectionAbstract' | 'PooledMySQLConnection':
                    ...
                    return MysqlTableAdapter[entity_type](self.__connection)
                case 'SqliteProxyConnection':
                    from ..sqlite import SqliteTableAdapter
                    return SqliteTableAdapter[entity_type](self.__connection)
                case 'MongoProxyConnection':
                    from ..mongodb import MongoTableAdapter
                    return MongoTableAdapter[entity_type](self.__connection)
